...
///
/// All three lists share the same length — exactly [TokenizerConfig.maxLength].
///
/// ```
...
class TokenizerOutput {
  ...
  ///
  /// All three lists must have the same length. This constructor is primarily
  /// intended for internal use and testing; prefer the tokenizer's
  /// `encode` / `encodePair` methods to produce instances.
  ...
  /// Total number of token slots (equals [TokenizerConfig.maxLength]).
  ...
  @override
  String toString() => 'TokenizerOutput('
      'length: $length, '
